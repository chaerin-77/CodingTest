...
void calc(int result, int count)
{
    if (count == N)
    {
    ...
    for (int i = 0; i < 4; i++)
    {
        if(oper[i] > 0)
        {
            ...
            if(i == 0) calc(result + num[count], count + 1);
            else if(i == 1) calc(result - num[count], count + 1);
            else if(i == 2) calc(result * num[count], count + 1);
            else calc(result / num[count], count + 1);
